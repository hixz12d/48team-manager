        ...
        items.append(
            {
                ...
                "proxy_source": owner.proxy_source if owner else None,
                "sub2api_proxy_id": owner.sub2api_proxy_id if owner else None,
        ...
        items.append(
            {
                ...
                **auth_status,
                ...
                "mailbox": {
                    "provider": account.mailbox_provider,
                    "account_id": account.hme_account_id,
                    "binding_state": "verified" if account.mailbox_binding_verified_at else "unbound",
                    "read_state": account.mailbox_read_state,
                    "method": account.mailbox_method,
                    "checked_at": isoformat(account.mailbox_checked_at),
                },
                "auto_reauth_opt_in": bool(account.auto_reauth_opt_in),
